 ...
 * Primary variant is a real Nigerian landmark photo; remaining variants are
 * Unsplash civic/urban scenes (no human faces, public spaces only).
 */
import { asset } from "@/lib/asset";

export const STATE_LANDMARK_VARIANTS: Record<string, string[]> = {
  "Enugu State": [
    asset("/enugu-landmark.jpg"),
