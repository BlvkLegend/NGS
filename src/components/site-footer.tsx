  ...
  return (
    <footer className="border-t border-line">
      <div className="mx-auto max-w-[1400px] px-6 py-14 lg:px-10">
        <div className="grid gap-10 md:grid-cols-[1.3fr_1fr_1fr_1fr] md:gap-12">
          <div>
            ...
            <p className="mt-3 max-w-xs text-[13px] leading-relaxed text-ink-muted">
              An independent, citizen-built register for evaluating elected officials
              across Nigeria: structured, evidence-aware, non-partisan.
            </p>
          </div>
        ...
        <div className="mt-14 flex flex-col-reverse items-start justify-between gap-4 border-t border-line pt-6 text-[12px] text-ink-muted sm:flex-row sm:items-center">
          <span>© 2026 NGSC. Not affiliated with INEC or any government body.</span>
          <span className="ledger-index">Register No. NGSC-2026</span>
        </div>
      </div>
    </footer>
  );
