...
// Verified free Unsplash images (Nigerian photographers where possible)
const IMG_LAGOS_STREET = "https://images.unsplash.com/photo-1648023199223-25d3622bcb13?auto=format&fit=crop&w=400&q=70";
const IMG_LAGOS_NIGHT = "https://images.unsplash.com/photo-1593717191400-84f38ee95485?auto=format&fit=crop&w=400&q=70";
const IMG_LAGOS_MARINA = "https://images.unsplash.com/photo-1649502913092-fb7f0e8fc632?auto=format&fit=crop&w=400&q=70";
  ...
  return (
    <section id="how-it-works" className="mx-auto max-w-[1400px] px-6 py-14 lg:px-10 scroll-mt-16">
      ...
      <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <BentoCell delay={0}>
          ...
          <div className="mt-3 overflow-hidden rounded-lg">
            <img src={IMG_LAGOS_MARINA} alt="Lagos Marina" className="h-20 w-full object-cover opacity-60" loading="lazy" />
          </div>
        ...
        <BentoCell delay={0.05}>
          ...
          <div className="mt-3 overflow-hidden rounded-lg">
            <img src={IMG_LAGOS_STREET} alt="Lagos street" className="h-20 w-full object-cover opacity-50" loading="lazy" />
          </div>
          <div className="mt-3 flex-1">
        ...
        <BentoCell delay={0.15}>
          ...
          <div className="mt-3 overflow-hidden rounded-lg">
            <img src={IMG_LAGOS_NIGHT} alt="Lagos at night" className="h-20 w-full object-cover opacity-50" loading="lazy" />
          </div>
      ...
      <motion.div
        ...
        className="mt-10 flex flex-col items-start gap-8 rounded-2xl border border-line bg-paper-raised p-6 sm:p-8 lg:flex-row lg:items-center lg:gap-12"
      >
        <div className="max-w-sm">
          <span className="ledger-index text-[11px] text-forest-500">{c.payoffEyebrow}</span>
          <p className="mt-3 text-[15px] leading-relaxed text-ink">{c.payoffBody}</p>
        </div>
        <div className="mx-auto w-full max-w-[340px] rotate-[-1.5deg] transition-transform duration-500 hover:rotate-0 lg:mx-0">
