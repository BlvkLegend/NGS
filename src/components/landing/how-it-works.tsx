...
export function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="mx-auto max-w-[1400px] scroll-mt-16">
      {/* Hero photo band — Lagos National Theatre, striking Nigerian civic architecture */}
      <div className="relative -mx-6 h-44 overflow-hidden lg:-mx-10 sm:h-52">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(0,0,0,0.75) 0%, rgba(0,0,0,0.45) 55%, rgba(0,0,0,0.15) 100%), " +
        ...
        <div className="absolute inset-0 flex flex-col justify-end px-6 pb-5 lg:px-10">
          <span className="ledger-index text-[12px] text-forest-300">{c.eyebrow}</span>
          <h2 className="mt-1 max-w-md text-2xl font-bold text-paper sm:text-3xl">{c.title}</h2>
        </div>
      </div>
      ...
      <div className="px-6 py-8 lg:px-10">
        ...
        {/* Step 1: Find */}
        <BentoCell delay={0} icon={<Search size={16} />}>
        ...
        {/* Step 2: Answer */}
        <BentoCell delay={0.05} icon={<ListChecks size={16} />}>
          {/* Progress bar */}
        ...
        {/* Step 3: NGSC Card */}
        <BentoCell delay={0.1} icon={<CreditCard size={16} />}>
          {/* Card visual */}
        ...
        {/* Step 4: Share */}
        <BentoCell delay={0.15} icon={<Share2 size={16} />}>
          <div className="mt-3 flex-1">
            ...
            {/* Shareable link preview — no real leader name */}
            <div className="mt-3 rounded-lg border border-line bg-paper px-3 py-2">
              ...
              <p className="font-mono text-[10px] text-ink-muted truncate">ngsc.ng/card/your-official</p>
            </div>
            {/* Record indicator */}
