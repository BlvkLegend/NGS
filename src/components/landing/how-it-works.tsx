...
// Nigerian voter at a polling unit — civic participation, no identifiable close-up
const HERO_PHOTO = asset("/voting.webp");
...
export function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="mx-auto max-w-[1400px] px-6 py-14 lg:px-10 scroll-mt-16">
      {/* Photo band: voter at a polling unit, civic participation */}
      <div className="relative -mx-6 mb-8 h-40 overflow-hidden rounded-b-2xl lg:-mx-10 sm:h-48 lg:h-56">
        <img
          src={HERO_PHOTO}
          alt=""
          aria-hidden
