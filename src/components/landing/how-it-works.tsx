...
const COPY = {
  ...
  cruise: {
    ...
    title: "Four moves, one verdict.",
    find: {
      title: "Pick who you wan drag",
      body: "Search name, state, or office.",
      placeholder: "Who you dey find...",
      suggestions: ["Governor", "Senator", "Abuja"],
    },
    answer: {
      title: "Do the ten gbege questions",
      body: "Roads, light, health, school — all of am.",
        ...
        <BentoCell delay={0.15} icon={<Share2 size={16} />} stepLabel="04">
          <div className="mt-3 flex-1">
            ...
            <div className="mt-3 rounded-lg border border-line bg-paper px-3 py-2">
              ...
              <p className="font-mono text-[10px] text-ink-muted truncate">ngsc.ng/card/adaeze-nwosu</p>
            </div>
            {/* Record indicator */}
