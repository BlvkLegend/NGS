...
// Real platform icons as inline SVGs
    ...
    <section className="mx-auto max-w-[1400px] px-6 py-10 lg:px-10 lg:py-12">
      ...
      >
        ...
        <div className="grid gap-3 sm:grid-cols-[1fr_1.6fr]">
          ...
          {/* Share bento — real platform icons */}
          <TiltCard className="p-6" intensity={6}>
            <div className="flex items-start justify-between">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-forest-tint text-forest-500">
                <Search size={20} />
            ...
            {/* Share row with real social icons */}
            <div className="mt-5 flex items-center gap-3">
              ...
              {/* X / Twitter */}
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#000000] text-white shadow-sm">
                <XIcon />
              </div>
              {/* Instagram */}
              <div
              ...
              {/* Link copy */}
              <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-line bg-paper-raised text-ink-muted shadow-sm">
                <svg viewBox="0 0 24 24" className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth={2} aria-hidden>
                  <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <span className="text-[12px] text-ink-muted">Copy link</span>
            </div>
            ...
            <div className="mt-5 border-t border-line pt-4">
              <h3 className="font-semibold text-ink">Share your NGSC card</h3>
              <p className="mt-1 text-[13px] text-ink-muted">
                Drop it on WhatsApp, X, or Instagram. One tap, ready to post.
              </p>
            </div>
          </TiltCard>
        </div>
