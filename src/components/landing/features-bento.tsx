...
const COPY = {
  ...
  cruise: {
    ...
    f3: { title: "Two modes, one receipt", body: "Taxpayer dey calm. Cruise dey dragging." },
    ...
    compare: { title: "Line them up", body: "Same ten questions. Numbers go do the dragging." },
  },
};
