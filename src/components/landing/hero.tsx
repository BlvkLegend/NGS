        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <div className="relative flex flex-1 flex-col justify-center gap-1 px-4 py-3">
              ...
              <h3 className="text-[16px] font-bold leading-tight text-gray-900 sm:text-[17px]">Taxpayer Mode</h3>
              ...
              <div className="mt-1.5 flex gap-1">
                {["A", "B", "C", "D", "F"].map((g) => (
                  <span
                    key={g}
                    className="flex h-5 w-5 items-center justify-center rounded border border-gray-400/60 font-mono text-[9px] font-bold text-gray-500"
                  >
                    {g}
                  </span>
                ))}
          ...
          >
            ...
            <div className="relative flex flex-1 flex-col justify-center gap-1 px-4 py-3">
              ...
              <h3 className="text-[16px] font-bold leading-tight text-gray-900 sm:text-[17px]">Agbado Cruise Mode</h3>
