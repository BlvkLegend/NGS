      ...
      >
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            {/* Dark bg so black-suit illustration reads clearly */}
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, rgba(0,0,0,0.90) 0%, rgba(0,0,0,0.60) 40%, transparent 75%)",
              }}
            />
            ...
            <div className="absolute inset-x-0 bottom-0 z-10 p-4">
              ...
              >
                ...
                {/* Example question */}
                <div className="mt-2.5 rounded-lg border border-paper/15 bg-black/30 p-2">
          ...
          >
            {/* Warm dark bg so yellow outfit illustration reads */}
            <div className="absolute inset-0 bg-[#1a1100]" />
            <img
              src={CRUISE_PHOTO}
              alt=""
              aria-hidden
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, rgba(0,0,0,0.90) 0%, rgba(0,0,0,0.55) 40%, transparent 75%)",
              }}
            />
