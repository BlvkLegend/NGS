  ...
  return (
    ...
    <section className="relative mx-auto max-w-[1400px] -mt-16 overflow-hidden px-6 pb-10 lg:px-10 lg:pb-14">
      ...
      <div className="relative max-w-2xl pt-24 lg:pt-28">
        ...
        >
          {mode === "cruise" ? "Oya drag them. Your vote, your verdict." : "Hold them to account. With receipts."}
        </motion.h1>
        ...
        >
          {mode === "cruise"
            ? "Ten questions. One card. Your honest rating of who dey deliver and who dey form. Sharp sharp for group chat."
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          >
            ...
            <div className="relative flex flex-1 flex-col justify-center gap-1 bg-paper-raised px-4 py-3">
              ...
              {mode === "taxpayer" && (
                <span className="absolute right-3 top-3 rounded-full bg-forest-500 px-2 py-0.5 text-[9px] font-bold uppercase text-paper shadow">
                  Active
                </span>
              )}
          ...
          >
            ...
            <div className="relative flex flex-1 flex-col justify-center gap-1 bg-paper-raised px-4 py-3">
              <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-white/25 to-transparent" />
              {mode === "cruise" && (
                <span className="absolute right-3 top-3 rounded-full bg-cruise-500 px-2 py-0.5 text-[9px] font-bold uppercase text-paper shadow">
                  Active
                </span>
              )}
