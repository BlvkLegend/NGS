...
const COPY = {
  taxpayer: { eyebrow: "Trending evaluations", title: "Most evaluated this week.", link: "See all officials" },
  cruise: { eyebrow: "Who everybody dey drag", title: "These ones trending for the wrong reasons.", link: "See all the ogas" },
};

const TRENDING_PHOTO = asset("/voting-bg.png");
    ...
    <section className="mx-auto max-w-[1400px] px-6 py-10 lg:px-10">
      ...
      <div className="relative mb-8 h-36 w-full overflow-hidden rounded-2xl sm:h-44">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-6">
          <span className="text-[11px] font-semibold uppercase tracking-[0.16em] text-forest-300">{copy.eyebrow}</span>
          <h2 className="mt-2 max-w-sm text-2xl font-bold text-paper sm:text-3xl">{copy.title}</h2>
        </div>
      </div>
