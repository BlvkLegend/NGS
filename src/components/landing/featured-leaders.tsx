...
const COPY = {
  taxpayer: { eyebrow: "Currently trending", title: "Most evaluated this week", link: "View all leaders" },
  cruise: { eyebrow: "Who dey trend", title: "Who everybody dey drag this week", link: "See everybody" },
};
