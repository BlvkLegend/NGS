...
export function ClosingCta() {
  ...
  return (
    <section className="relative overflow-hidden border-t border-line bg-[#0a2e22] dark:bg-[#0a2e22]">
      <img
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 py-20 lg:px-10">
        <div className="max-w-2xl">
          {mode === "cruise" ? (
            <>
              ...
              <p className="mt-4 text-[16px] leading-relaxed text-paper/70">
                Your rating enter a running public score wey journalists, civil society,
                and opposition fit quote. No be just group chat noise.
                Na a citable file. That na wetin your voice become on NGSC. Abeg do am.
              </p>
            </>
          ) : (
            <>
          ...
          >
            {mode === "cruise" ? "Drop your first verdict" : "File your verdict"}
            <ArrowRight size={15} />
          </Link>
        </div>
      </div>
