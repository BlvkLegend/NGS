        ...
        <div className="max-w-2xl">
          {mode === "cruise" ? (
            ...
            <>
              ...
              <p className="mt-4 text-[16px] leading-relaxed text-paper/70">
                Your evaluation enter a running public score wey journalists, civil
                society, and opposition fit quote. Not just group chat noise.
                A citable file. That na wetin your voice become on NGSC.
              </p>
            </>
          )}
          <Link
