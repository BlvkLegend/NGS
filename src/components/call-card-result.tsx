    ...
    <div className="mx-auto max-w-5xl px-6 py-14">
      ...
      <div className="mt-10 grid gap-14 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div>
          ...
          >
            <p className="text-[13px] uppercase tracking-wide text-ink-muted">Governance score</p>
            <div className="mt-2 flex items-baseline gap-3">
              <span className="font-mono text-5xl font-medium text-ink">{score}</span>
              <span className="text-lg text-ink-muted">/ 100 · grade {scoreToGrade(score)}</span>
            </div>
            ...
            <div className="mt-4 flex items-center gap-2 text-[13px]">
              ...
              <span className={diff >= 0 ? "text-signal-good" : "text-signal-low"}>
                {Math.abs(diff)} points {diff >= 0 ? "above" : "below"} the public average of {PUBLIC_AVERAGE}
              </span>
            </div>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-3 border-t border-line pt-8">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl border border-line px-5 py-2.5 text-[14px] font-medium text-ink transition-colors hover:border-line-strong"
            >
            ...
            >
              Compare with others <ArrowRight size={15} />
            </a>
          </div>
        </div>
      </div>
