...
export function CallCardResult({ leader }: { leader: Leader }) {
  ...
  return (
    <div className="mx-auto max-w-5xl px-6 py-14">
      ...
      >
        Evaluation filed. Governance Call Card generated
      </motion.span>
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2 text-[13px]">
              ...
              <span className={diff >= 0 ? "text-signal-good" : "text-signal-low"}>
                {Math.abs(diff)} points {diff >= 0 ? "above" : "below"}
              </span>
              <span className="text-ink-muted">the public average of {PUBLIC_AVERAGE}</span>
            </div>
