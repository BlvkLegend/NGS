...
const TABS = ["Top rated", "Most evaluated", "Lowest rated"] as const;
...
export function RankingsList() {
  ...
  const sorted = useMemo(() => {
    const copy = [...leaders];
    if (tab === "Top rated") return copy.sort((a, b) => b.score - a.score);
    if (tab === "Lowest rated") return copy.sort((a, b) => a.score - b.score);
    return copy.sort((a, b) => b.evaluations - a.evaluations);
  }, [tab]);
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1 flex items-center gap-3 text-[11px] text-ink-muted">
                  <span>Score: <span className="font-mono text-ink">{leader.score}</span></span>
                  <span>{leader.evaluations.toLocaleString()} PTS</span>
                </div>
              </div>
