...
// Deterministic portrait photos — placeholder composites until real photos are uploaded
const LEADER_PHOTOS: Record<string, string> = {
  "bola-tinubu":              "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=80&q=80",
  "babajide-sanwo-olu":       "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?auto=format&fit=crop&w=80&q=80",
  "charles-soludo":           "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=80&q=80",
  "peter-mbah":               "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=80&q=80",
  "babagana-zulum":           "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=80&q=80",
  "nyesom-wike":              "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=80&q=80",
  "festus-keyamo":            "https://images.unsplash.com/photo-1504257432389-52343af06ae3?auto=format&fit=crop&w=80&q=80",
  "bosun-tijani":             "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?auto=format&fit=crop&w=80&q=80",
  "godswill-akpabio":         "https://images.unsplash.com/photo-1463453091185-61582044d556?auto=format&fit=crop&w=80&q=80",
  "natasha-akpoti-uduaghan":  "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=80&q=80",
};
        ...
        <div className="w-72 overflow-hidden rounded-xl border border-line-strong bg-paper-raised/95 shadow-card backdrop-blur-md">
          ...
          <ul className="divide-y divide-line">
            {ranked.slice(0, 5).map((l, i) => {
              const photo = LEADER_PHOTOS[l.slug];
              return (
