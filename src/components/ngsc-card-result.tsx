  ...
  return (
    <div className="relative min-h-[calc(100vh-80px)] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6 py-14">
        ...
        >
          Evaluation filed · NGSC card ready · Nigeria Governance Scorecard
        </motion.span>
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative flex items-center justify-between px-6 py-5">
              <div className="flex items-center gap-3">
                ...
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border-2 border-paper/30 bg-paper/15 text-paper">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-[1.15rem] font-bold text-paper">{leader.name}</p>
                  <p className="text-[12px] text-paper/60">{leader.role} · {leader.jurisdiction}</p>
                </div>
              </div>
              {/* Overall grade stamp */}
              <div className={`flex h-20 w-20 shrink-0 flex-col items-center justify-center rounded-xl border-2 bg-paper/10 backdrop-blur-sm ${GRADE_COLOR[grade]}`}>
                ...
                <span className="font-mono text-[9px] text-paper/60">{score}/100</span>
              </div>
            </div>
          </div>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-line bg-paper">
                  <th className="px-6 py-2.5 font-mono text-[11px] font-medium uppercase tracking-wide text-ink-muted">Category</th>
                  ...
                  <th className="w-28 px-6 py-2.5 font-mono text-[11px] font-medium uppercase tracking-wide text-ink-muted">Bar</th>
                </tr>
              </thead>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-forest-500 px-5 py-2.5 text-[14px] font-semibold text-paper transition-colors hover:bg-forest-700 disabled:opacity-60"
          >
            <Download size={15} /> {downloading ? "Preparing..." : "Download"}
          </button>
          <button
            onClick={handleCopyLink}
            className="flex items-center gap-2 rounded-full border border-paper/30 px-5 py-2.5 text-[14px] font-medium text-paper transition-colors hover:border-paper/60"
          >
          ...
          {/* Compare link — route() helper prevents GitHub 404 */}
          <Link
            href={compareHref}
            className="ml-auto flex items-center gap-1.5 text-[14px] font-medium text-paper/70 hover:text-paper"
          >
