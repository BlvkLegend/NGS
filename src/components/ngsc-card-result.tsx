    ...
    <div className="relative min-h-[calc(100vh-80px)] overflow-hidden">
      ...
      <div className="relative mx-auto max-w-3xl px-6 py-14">
          ...
          <div className="bg-paper">
            ...
            <div className="border-t border-line px-6 py-5">
              <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
                ...
                <div className={`shrink-0 rounded-lg border px-4 py-2 text-center ${GRADE_COLOR[grade]}`}>
                  ...
                  <p className="mt-0.5 text-[13px] font-bold">
                    {mode === "cruise" ? (score >= 80 ? "Sharp Sharp" : score >= 65 ? "E do" : score >= 50 ? "Half Half" : score >= 35 ? "E no do" : "Terrible") : (score >= 80 ? "Distinction" : score >= 65 ? "Credit" : score >= 50 ? "Pass" : score >= 35 ? "Fail" : "Fail (Poor)")}
                  </p>
                </div>
              </div>
              <div className="mt-4 border-t border-line pt-4 font-mono text-[10px] text-ink-muted">
                ...
                <span>{mode === "cruise" ? "NGSC citizen drag. Na your verdict, not government record." : "NGSC citizen evaluation. Not an official government record."}</span>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          <Link
            href={compareHref}
            className="ml-auto flex items-center gap-1.5 text-[14px] font-medium text-white/70 hover:text-white"
          >
