...
export function NavSearch() {
  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-11 w-72 rounded-xl border border-line-strong bg-paper-raised p-3 shadow-card">
        <div className="flex items-center gap-2 rounded-lg border border-line bg-paper px-3 py-2">
            ...
            <input
              ...
              placeholder={mode === "cruise" ? "Who you dey find?" : "Search by name, state, office"}
