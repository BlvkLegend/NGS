...
export function AuthShell({
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="hidden flex-col justify-between bg-[#0a2e22] dark:bg-[#0a2e22] p-10 lg:flex">
        <Link href="/" className="flex items-center gap-2">
          <Image src={asset("/ngsc-logo.png")} alt="NGSC" width={28} height={28} className="h-7 w-7" />
          <span className="font-display text-xl font-semibold text-paper">NGSC</span>
        </Link>
