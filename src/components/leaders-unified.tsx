      ...
      <div className="mt-6 space-y-4">
        ...
        <div className="relative max-w-sm">
          ...
          <input
            ...
            placeholder={mode === "cruise" ? "Search by name, state, party..." : "Search by name, state, party, or office"}
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="truncate text-[10px] text-ink-muted/70">
                      {leader.party} · {leader.evaluations.toLocaleString()} {mode === "cruise" ? "gbas" : "evals"}
                    </p>
                  </div>
        ...
        <p className="text-[12px] text-ink-muted">
          {ranked.length} {mode === "cruise" ? "ogas" : "results"}
          {officeFilter !== "All" ? ` · ${officeFilter}` : ""}
          {query ? ` matching "${query}"` : ""}
          {" "}· {rankCategory}, {rankDir === "desc"
            ? (mode === "cruise" ? "highest first" : "highest first")
            : (mode === "cruise" ? "lowest first" : "lowest first")}
        </p>
      </div>
    </div>
  );
