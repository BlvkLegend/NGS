...
const LEFT_PHOTO = "https://images.unsplash.com/photo-1648023199223-25d3622bcb13?auto=format&fit=crop&w=900&q=75";
  ...
  return (
    <div className="flex min-h-[calc(100vh-80px)]">
      ...
      <div className="relative hidden flex-1 overflow-hidden lg:block">
        ...
        />
        {/* Stat overlay anchored bottom-left */}
        <div className="absolute bottom-10 left-10 space-y-3">
          {[
            ...
            <div key={s.label} className="flex items-baseline gap-2">
              ...
              <span className="text-[13px] font-medium text-paper/70">{s.label}</span>
            </div>
          ))}
        </div>
      </div>
