...
export function DepthButton({
  ...
  const shared = `relative isolate inline-flex items-center justify-center gap-1.5 overflow-hidden rounded-full px-6 py-3 text-[14px] font-medium text-paper transition-transform duration-150 ${
    pressed ? "translate-y-[1px] scale-[0.98]" : ""
  } ${
    disabled ? "cursor-not-allowed opacity-40" : "cursor-pointer"
  } ${gradient} ${
    pressed
      ? "shadow-[inset_0_2px_4px_rgba(0,0,0,0.35),0_0_0_1px_rgba(0,0,0,0.25)]"
      : "shadow-[0_1px_0_rgba(255,255,255,0.35)_inset,0_10px_20px_-8px_rgba(0,0,0,0.45),0_0_0_1px_rgba(0,0,0,0.15)] hover:shadow-[0_1px_0_rgba(255,255,255,0.4)_inset,0_14px_26px_-6px_rgba(0,0,0,0.5),0_0_0_1px_rgba(0,0,0,0.18)]"
  } ${className}`;
