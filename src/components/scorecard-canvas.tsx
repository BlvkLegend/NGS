      ...
      <div className="relative mx-auto max-w-lg px-6 py-14">
        ...
        {unlocked && (
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
            <button onClick={() => shareTo("native")} className="flex items-center gap-1.5 rounded-full bg-forest-500 px-4 py-2 text-[13px] font-medium text-paper transition-colors hover:bg-forest-700">
