    ...
    <div className="mx-auto max-w-lg px-6 py-14">
      ...
      <div className="relative mt-6">
        ...
        >
          <div
            aria-hidden
            className="pointer-events-none absolute -right-10 -top-10 h-44 w-44 rounded-full bg-paper/10 blur-2xl"
          />
          <div
            aria-hidden
          ...
          <div className="relative px-6 pt-7">
            <div className="flex items-center justify-between">
              <p className="font-mono text-[9px] font-semibold uppercase tracking-[0.22em] text-paper/60">NGSC</p>
              <p className="font-mono text-[9px] uppercase tracking-[0.16em] text-paper/60">
                {leader.jurisdiction}
              </p>
            </div>
            <div className="mt-6 flex items-end justify-between">
              <div>
                <span className="flex h-14 w-14 items-center justify-center rounded-full bg-paper/10 text-paper ring-1 ring-paper/20">
                  <UserRound size={24} strokeWidth={1.5} />
                </span>
                <h2 className="mt-3 font-display text-[1.3rem] font-bold leading-tight text-paper">
                  {leader.name}
                </h2>
                <p className="mt-0.5 text-[11px] text-paper/60">{leader.role}</p>
              </div>
              <div className="flex flex-col items-end">
                <p className="font-mono text-[5rem] font-black leading-none text-paper drop-shadow-lg">
                  {score}
                </p>
                <p className="text-[9px] uppercase tracking-[0.2em] text-paper/60">/ 100</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative px-6 pb-6">
            <div className="rounded-xl bg-paper/10 px-4 py-3 backdrop-blur-sm">
              <p className="mb-2.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-paper/60">NGSC verdict</p>
