    ...
    <div className="relative mx-auto flex aspect-[9/16] w-full max-w-[320px] flex-col justify-between overflow-hidden rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.4)]">
      ...
      <div className="relative px-6 pt-7">
        ...
        <div className="mt-5 flex items-start justify-between gap-2">
          <div className="flex-1">
            <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-white/40 bg-white/12 text-white">
      ...
      <div className="relative px-6 pb-6">
        ...
        <div className="mt-4 flex items-center justify-between border-t border-white/20 pt-3">
          <p className="text-[8px] uppercase tracking-[0.2em] text-white/55">ngsc.africa</p>
          ...
          <div className="flex items-start justify-between gap-2">
            <div className="flex-1">
              ...
              <div className="mt-2 flex items-center gap-2">
                <div className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 bg-white/12 text-white">
      ...
      <div className="relative px-5 pb-5">
        ...
        >
          ...
          <div className="mt-3 flex items-center justify-between border-t border-white/15 pt-2">
            <p className="text-[8px] uppercase tracking-[0.18em] text-white/50">ngsc.africa</p>
