    ...
    <div className="relative mx-auto flex aspect-[9/16] w-full max-w-[320px] flex-col justify-between overflow-hidden rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.4)]">
      ...
      <div className="relative px-6 pt-7">
        <div className="flex items-center justify-between">
          <p className="font-mono text-[8px] font-bold uppercase tracking-[0.26em] text-paper">
            NIGERIA GOVERNANCE SCORECARD
          </p>
        </div>
        <p className="mt-0.5 font-mono text-[8px] uppercase tracking-[0.18em] text-paper/60">
          {leader.jurisdiction}
        </p>

        <div className="mt-5 flex items-start justify-between gap-2">
          <div className="flex-1">
            <div className="flex h-12 w-12 items-center justify-center rounded-full border-2 border-paper/40 bg-paper/12 text-paper">
              <UserRound size={20} strokeWidth={1.5} />
            </div>
            <h2 className="mt-2.5 text-[1.2rem] font-bold leading-tight text-paper drop-shadow-sm">
              {leader.name}
            </h2>
            <p className="mt-0.5 text-[10px] font-medium text-paper/75">{leader.role}</p>
          </div>

          {/* Grade stamp — white bordered box, no gradient */}
          <div className="flex flex-col items-center rounded-xl border-2 border-paper/50 bg-paper/12 px-3 py-2 backdrop-blur-sm">
            <span className="font-mono text-[3rem] font-black leading-none text-paper drop-shadow">
              {grade}
            </span>
            <span className="font-mono text-[8px] text-paper/60">{score}/100</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative px-5 pt-6">
        ...
        >
          <div className="flex items-start justify-between gap-2">
            <div className="flex-1">
              <p className="font-mono text-[8px] font-bold uppercase tracking-[0.24em] text-paper/70">NGSC · Agbado Cruise</p>
              <p className="font-mono text-[8px] uppercase tracking-[0.14em] text-paper/50">{leader.jurisdiction}</p>
      ...
      <div className="relative mx-auto max-w-lg px-6 py-14">
        ...
        <div className="mt-5">
          <p className="mb-2 text-center text-[10px] font-medium uppercase tracking-wide text-paper/55">
            {mode === "taxpayer" ? "Choose your textile" : "Choose your landmark"}
          </p>
        ...
        <div className="mt-6 flex flex-col items-center gap-2">
          <Link href={route(`/card/${leader.slug}?s=${score}`)} className="flex items-center gap-1.5 text-[13px] font-medium text-paper/80 hover:text-paper">
            View the full record <ArrowRight size={14} />
          </Link>
          {unlocked && nextLeader && (
            <Link href={route(`/evaluate/${nextLeader.slug}`)} className="flex items-center gap-1.5 text-[13px] font-medium text-paper/55 hover:text-paper/80">
