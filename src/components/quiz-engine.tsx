    ...
    return (
      <div className="relative flex min-h-[calc(100vh-80px)] flex-col items-center justify-center overflow-hidden px-6 text-center">
        ...
        <div className="relative">
          ...
          <p className="mt-2 text-[13px] text-paper/60">{leader.name} · {leader.jurisdiction}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="relative flex min-h-[calc(100vh-80px)] flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col">
        <AnimatePresence mode="wait">
          ...
          >
            <span className="inline-block rounded-full border border-paper/25 bg-black/45 px-2.5 py-0.5 text-[11px] font-semibold text-paper backdrop-blur-sm">
              {question.category}
            </span>
