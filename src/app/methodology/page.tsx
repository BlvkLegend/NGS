...
export default function MethodologyPage() {
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      {/* FULL-BLEED HERO — consistent with About page */}
        ...
        <div className="relative mx-auto flex h-full max-w-[1400px] flex-col justify-end px-6 pb-14 pt-32 lg:px-10">
          ...
          <p className="mt-5 max-w-xl text-[16px] leading-relaxed text-white/75">
            {mode === "cruise"
              ...
              : "Every evaluation on NGSC follows the same structure regardless of which official is scored or which mode was used. That consistency is what makes one governor's grade comparable to another's."}
          </p>
        </div>
      </div>
          ...
          <div className="flex items-start gap-4 rounded-2xl border border-forest-500/30 bg-forest-tint/40 p-6">
            ...
            <div>
              <h3 className="text-[15px] font-semibold text-ink">
                {mode === "cruise" ? "Blocking bad-faith drags" : "Guarding against noise"}
              </h3>
              <p className="mt-2 text-[13px] leading-relaxed text-ink-muted">
                {mode === "cruise"
                  ? "No system immune to people wey wan game am. NGSC roadmap include photo and clip evidence to back drags, plus pattern detection to catch coordinated fake entries before dem affect public score."
