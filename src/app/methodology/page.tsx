...
const GRADE_SCALE = [
  { grade: "A", meaning: "Excellent",      range: "80 to 100", color: "text-signal-good border-signal-good", bg: "bg-[#e7efe6]" },
  { grade: "B", meaning: "Good",           range: "65 to 79",  color: "text-forest-500 border-forest-500",   bg: "bg-[#edf5f0]" },
  { grade: "C", meaning: "Average",        range: "50 to 64",  color: "text-signal-mid border-signal-mid",   bg: "bg-[#fdf8e4]" },
  { grade: "D", meaning: "Poor",           range: "35 to 49",  color: "text-cruise-500 border-cruise-500",   bg: "bg-[#fdeee0]" },
  { grade: "F", meaning: "Fail",           range: "0 to 34",   color: "text-signal-low border-signal-low",   bg: "bg-[#fce8e6]" },
];
...
export default function MethodologyPage() {
  ...
  return (
    <div className="min-h-screen bg-paper">
      <SiteHeader />
      <main className="mx-auto max-w-[960px] px-6 py-16 lg:px-10">
        ...
        <section className="mt-16 border-t border-line pt-12">
          ...
          <p className="mt-3 max-w-xl text-[14px] leading-relaxed text-ink-muted">
            Not star ratings, not numbers — letter grades with clear definitions so
            ...
            {GRADE_SCALE.map((row, i) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-[15px] font-semibold text-ink">{row.meaning}</p>
                </div>
                <span className="font-mono text-[13px] text-ink-muted">{row.range}</span>
              </motion.div>
            ))}
          </div>
        </section>
